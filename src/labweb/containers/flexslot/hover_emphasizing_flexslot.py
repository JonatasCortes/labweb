...
from src.labweb.constants import VerticalAlignment, HorizontalAlignment
...
class HoverEmphasizingFlexSlot(ProtectedFlexSlot, HoverEmphasizingArea):
    ...
    def copy(self) -> "HoverEmphasizingFlexSlot":
